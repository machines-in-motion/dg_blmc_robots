...
filename_fff =  "/home/ameduri/devel/workspace/src/catkin/control/kino-dynamic-opt/momentumopt/demos/quadruped_forces_with_horizon.dat"
filename_end_eff =  "/home/ameduri/devel/workspace/src/catkin/control/kino-dynamic-opt/momentumopt/demos/quadruped_positions_abs_with_horizon.dat"
...
reader_fff.selec.value = (12*(horizon + 1))*'1' + '0'
reader_end_eff.selec.value = (12*(horizon + 1))*'1' + '0'
...
plug(reader_end_eff.vector, reactive_lqr_ctrl.end_eff_pos)
plug(reader_fff.vector, reactive_lqr_ctrl.des_fff)
...
for i in range(1000):
    ...
    # reader_end_eff.vector.recompute(i)
    # print(reader_end_eff.vector.value)
