...
pos_des_fl, vel_des_fl = circular_trajectory_generator(0.04, 0.06, 1.5, 0.0, "traj_fl" )
pos_des_fr, vel_des_fr = circular_trajectory_generator(0.04, 0.06, 1.5, 0.0, "traj_fr" )
pos_des_hl, vel_des_hl = circular_trajectory_generator(0.04, 0.06, 1.5, np.pi/2.0, "traj_hl" )
pos_des_hr, vel_des_hr = circular_trajectory_generator(0.04, 0.06, 1.5, np.pi/2.0, "traj_hr" )
